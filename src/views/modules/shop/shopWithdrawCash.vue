    ...
    <div class="search-bar">
      <el-form @submit.native.prevent :inline="true" class="search-form" ref="searchForm" :model="searchForm" size="small">
        <div class="input-row">
          ...
          <div class="default-btn primary-btn" @click="setUpHandle()">提现设置</div>
          <set-up v-if="dialogFormVisible" ref="setUp"></set-up>
        </div>
      </el-form>
    </div>
    <div class="main-container">
      <div class="table-con">
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <div class="table-cell-image">
                <ImgShow :src="scope.row.shopLogo" />
              </div>
            </template>
          </el-table-column>
          <el-table-column
          ...
          >
            <template slot-scope="scope">
              <span >{{scope.row.auditingTime || '-'}}</span>
            </template>
          </el-table-column>
          <el-table-column
...
import SetUp from './shopWithdrawCash-setUp'
export default {
  data () {
    return {
