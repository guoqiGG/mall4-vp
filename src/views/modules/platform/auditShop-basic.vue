<template>
  <div class="mod-seckill-shopAuditing">
    <div class="search-bar">
      <el-form @submit.native.prevent :inline="true" ref="searchForm" :model="searchForm" size="small" :class="this.$i18n.t('language') === 'language' ? 'en-search-form': 'zh-search-form'">
        <div class="input-row">
