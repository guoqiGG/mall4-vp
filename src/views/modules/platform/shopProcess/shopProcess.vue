                ...
                <div class="ci-wrapper">
                  <div class="left-info">
                    ...
                    <el-form-item :label="this.$i18n.t('shopProcess.tel')" prop="tel">
                      <el-input v-model="shopDetail.tel" oninput="value=value.replace(/[^\d]/g,'')" :placeholder="this.$i18n.t('shopProcess.telInputTips')" maxlength="11" />
                    </el-form-item>
                    <el-form-item :label="this.$i18n.t('shopProcess.email')" prop="email">
                      <el-input v-model="shopDetail.email" :placeholder="this.$i18n.t('shopProcess.emailInputTips')" maxlength="30" />
                    </el-form-item>
                  ...
                  <div class="right-info">
                    <el-form-item :label="this.$i18n.t('shopProcess.logo')" prop="shopLogo">
                      <div class="business-license-box">
                        <div class="license-content">
                          <img-upload v-model="shopDetail.shopLogo" @input="imgChange(shopDetail.shopLogo, 'shopLogo', 'shopDetail')" />
                        </div>
            ...
            <div class="register-info">
              ...
              >
                ...
                <el-form-item :label="this.$i18n.t('sys.password')" prop="password">
                  <el-input v-model="shopUserRegisterInfo.password" type="password" maxlength="16" :placeholder="this.$i18n.t('shopProcess.passwordRule')" show-password />
                </el-form-item>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      pickerOptionsStart: {
        disabledDate: time => {
          if (this.shopCompany.endTime) {
            return time.getTime() > new Date(this.shopCompany.endTime).getTime() - 86400000
          }
        }
      },
      pickerOptionsEnd: {
        disabledDate: time => {
          if (this.shopCompany.startTime) {
            return time.getTime() < new Date(this.shopCompany.startTime).getTime() + 86400000
          }
        }
      },
      // 工商信息校验
  ...
  methods: {
        ...
        if (this.mapLocationType === 'map') {
          gc.getLocation(point, function (rs) {
            ...
            if (rs) {
              ...
              addrDetail && (that.shopDetail.shopAddress = addrDetail)
            }
    ...
    formatAddrDetail (addrInfo) {
      const rex = new RegExp(`[${this.shopDetail.province}|${this.shopDetail.city}|${this.shopDetail.area}]`, 'g')
...
<style scoped>
.shop-process-container /deep/ .el-upload--picture-card i{
  font-size: 29px;
}
</style>