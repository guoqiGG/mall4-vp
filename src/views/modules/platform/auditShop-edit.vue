      ...
      <div v-if="navStatus === 2" class="contract-info table-box">
        ...
        <div class="s-category-item s-item">
          <div class="table-data-title">
            ...
            <div class="edit-btn">
              <div class="default-btn primary-btn" @click="addSigningHandle(0)">{{ $t('shopProcess.addSigningCategory') }}</div>
              <div class="default-btn primary-btn" @click="cateAddOrUpdateHandle(0)">{{$t('shopProcess.editSigningCategory')}}</div>
            </div>
          </div>
        ...
        <div class="s-brand-item s-item">
          <div class="table-data-title">
            ...
            <div class="edit-btn">
              <div class="default-btn primary-btn" @click="addSigningHandle(1)">{{ $t('shopProcess.addSigningBrand') }}</div>
              <div class="default-btn primary-btn" @click="cateAddOrUpdateHandle(1)">{{ $t('shopProcess.editSigningBrand') }}</div>
            </div>
          </div>
