  ...
  <div class="app-container shop-detail">
    ...
    <div class="shop-info-box">
        ...
        <div class="basic-info-list">
          <div class="left-info">
            ...
            <div class="basic-info-item">
              ...
              <p v-if="shopBasicInfo" class="txt">{{ shopBasicInfo.province }}{{ shopBasicInfo.city }}{{ shopBasicInfo.area }}</p>
            </div>
            <div class="basic-info-item">
        ...
        <div class="basic-info-list">
          <div class="left-info">
            ...
            <div class="basic-info-item">
              ...
              <p v-if="businessInfo.capital" class="txt">{{ businessInfo.capital }} {{ $t('shopProcess.tenThousandYuan') }}</p>
            ...
            <div class="basic-info-item">
              ...
              <p v-if="businessInfo.foundTime" class="txt">{{ businessInfo.foundTime.split(' ')[0] }}</p>
            ...
            <div class="basic-info-item">
              ...
              <p v-if="businessInfo.startTime" class="txt">{{ businessInfo.startTime.slice(0,10) + ' - ' + (!businessInfo.endTime ? $t('shopProcess.noFixedTerm') : businessInfo.endTime.slice(0, 10)) }}</p>
              <p v-if="!businessInfo.startTime" class="txt weak">{{ $t('order.notYet') }}</p>
            </div>
            <!-- <div class="basic-info-item">
          ...
          <div class="right-info">
            ...
            <div class="basic-info-item">
              <p class="tit"><span class="asterisk">*</span>{{ $t('shopProcess.corporateIdentityCard') }}：</p>
              <div class="txt bg-img">
                <el-image
              ...
              <p v-if="!businessInfo.identityCardFront && !businessInfo.identityCardLater" class="txt weak">{{ $t('order.notYet') }}</p>
            </div>
          </div>
        </div>
      ...
      <div v-if="navStatus === 2" class="contract-info table-box">
        ...
        <div v-if="pageType !== 'toAudit'">
          ...
          <div class="contracted-items s-item">
            <div class="tips">
              <div class="tit"><span class="asterisk">*</span>{{ $t('shopProcess.validityPeriodOfContract') }}</div>
          ...
          <div class="contracted-items s-item">
            ...
            <div class="si-content">
              <div>
                <el-radio v-model="shopBasicInfo.type" :label="0" disabled>{{ $t('shopProcess.ordinaryShop') }}</el-radio>
                <el-radio v-model="shopBasicInfo.type" :label="1" disabled>{{ $t('shopProcess.preferredGoodShop') }}</el-radio>
              </div>
            </div>
          </div>
        </div>
      ...
      <div v-if="navStatus === 3" class="financial-info">
        <div class="table-box">
          <div class="tips">
            <p class="tit"><span class="asterisk">*</span>{{ $t('shopProcess.settlementAccount') }}</p>
            <p class="txt weak">
              {{ $t('shopProcess.added') }}
    ...
    >
      <div class="content">
        ...
        <el-form @submit.native.prevent ref="auditform" label-width="auto" :model="auditform" :rules="auditformRules" size="small">
