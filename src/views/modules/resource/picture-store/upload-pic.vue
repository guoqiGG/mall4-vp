...
.elx-imgbox-dialog {
  ...
  .upload-img-preview ::v-deep .el-upload--picture-card {
    width: 78px !important;
    height: 78px !important;
    border-radius: 5px;
  }
  .upload-img-preview ::v-deep .el-upload-list--picture-card .el-upload-list__item{
    width: 78px !important;
    height: 78px !important;
    border-radius: 5px;
  }
...
div ::v-deep .el-upload--picture-card i {
  position: absolute;
  top: 50%;
  left: 50%;
  translate: -50% -50%;
}
.elx-imgbox-dialog ::v-deep .upload-img-preview .el-upload--picture-card {
  position: relative;
}
</style>
