<template>
  <el-dialog
    ...
    <el-form @submit.native.prevent :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" size="small" label-width="80px">
      ...
      <el-form-item :label="$t('sys.parameterValue')" prop="paramValue">
        <el-input v-model="dataForm.paramValue" :placeholder="$t('sys.parameterValue')"></el-input>
      </el-form-item>
