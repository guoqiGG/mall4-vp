  ...
  <div class="mod-home">
    ...
    <div class="refund-plate">
          ...
          <div class="refund-chart-msg">
            <div class="msg-tit-txt">
              ...
              <div>
                <el-date-picker 
                  size="small" 
                  v-model="trendDataRange1"
                  type="daterange"
                  :range-separator="$t('date.tip')"
                  value-format="yyyy-MM-dd"
                  :start-placeholder="trendDataRange1[0]"
                  :end-placeholder="trendDataRange1[1]"
                  @change="trendRangeChange(1)">
                </el-date-picker>
              </div>
        ...
        <div class="ranking-left">
          ...
          <div class="ranking-title">{{
            ...
            <span>
              <el-date-picker 
                size="small"
                v-model="shopDateRange"
                type="datetimerange"
                :range-separator="$t('date.tip')"
                value-format="yyyy-MM-dd HH:mm:ss"
                :start-placeholder="shopDateRange[0]"
                :end-placeholder="shopDateRange[1]"
                @change="shopListTimeChange">
              </el-date-picker>
            </span>
          </div>
      ...
      <div class="refund-chart-box">
          ...
          <div class="refund-chart-msg">
            <div class="msg-tit-txt">
              ...
              <div>
                <el-date-picker 
                  size="small"
                  v-model="trendDataRange2"
                  type="daterange"
                  :range-separator="$t('date.tip')"
                  value-format="yyyy-MM-dd"
                  :start-placeholder="trendDataRange2[0]"
                  :end-placeholder="trendDataRange2[1]"
                  @change="trendRangeChange(2)">
                </el-date-picker>
              </div>
              <div class="refund-tip">
        ...
        <!-- 热卖商品TOP10-->
        <div class="ranking-right" style="height: auto; min-height: 580px;">
          <div class="ranking-title">{{
            ...
            <span>
              <el-date-picker 
                size="small"
                v-model="prodDateRange"
                type="datetimerange"
                :range-separator="$t('date.tip')"
                value-format="yyyy-MM-dd HH:mm:ss"
                :start-placeholder="prodDateRange[0]"
                :end-placeholder="prodDateRange[1]"
                @change="prodListTimeChange">
              </el-date-picker>
            </span>
          </div>
...
<style scoped>
.msg-tit-txt ::v-deep .el-range-separator,
.ranking-title ::v-deep .el-range-separator {
  line-height: 32px;
  font-weight: normal;
  width: auto;
}
