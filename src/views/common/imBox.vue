          ...
          >
            ...
            >
              <img
                ...
                v-if="!item.pic"
              />
              <img :src="item.pic" class="shop-icon" v-else @error="item.pic=''" />
              <div class="shop-info">
...
export default {
  ...
  created () {
    ...
    localStorage.setItem('bbcImBox', true)
  },
  beforeDestroy () {
    ...
    async getConversations () {
      ...
      window.onbeforeunload = function () {
        if (that.$route.name === 'imBox') {
          localStorage.removeItem('bbcImBox')
        }
      }
      ...
      this.imSocketTask.onmessage = (res) => {
        ...
        if (result.code === '00000' || result.code === 4) {
          ...
          if (this.friends.length && result.code !== 4) {
            ...
            if (index != null && this.selectedF !== result.data.userId && result.data.userUnread) {
