const en = {
  ...
  product: {
    ...
    productSellingPointsTip: 'The selling point is displayed under the title of the item details and is no longer than 100 characters',
    remark: 'Remark',
    isTop: 'isTop',
    seq: 'sequence',
    ...
    prodNameTip: 'Recommended product name: Product description + attribute. The value contains a maximum of 60 characters',
  ...
  shopFeature: {
    ...
    header: {
      ...
      headerTip: 'Font/background only works for applet and APP',
