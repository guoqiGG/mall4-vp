const zhCn = {
  ...
  home: {
    ...
    visitorsInTheLastSevenDaysTip:
      "在统计时间内，今天的前7天所有用户访问系统的人数",
  ...
  prodList: {
    ...
    offShelfProd: "下架",
    content:
      "商品下架后，该商品的活动也将结束，可能会造成商家的经济损失，请谨慎操作",
    detailsTitle: "商品详情",
    parameters: "商品参数",
    sellingPoints: "商品卖点",
    specs: "规格",
  ...
  product: {
    ...
    video: "商品视频",
    prodName: "商品名称",
    prodNameTip: "商品名称建议：商品描述+属性，长度不超过60个字符",
    ...
    uploadProdTip:
      "1.上传的规格编码若为空或与已有的编码重复，系统将会自动生成新的编码值。",
    uploadProdTip2:
      "2.不建议在商品sku名称中填写冒号，容易导致数据错误并不能成功导入。",
    maxNum: "限购数量",
    ...
    userMustFollRule:
      "用户应遵守国家法律、行政法规、部门规章等规范性文件。对任何涉嫌违反国家法律、行政法规、部门规章等规范性文件的行为， 本平台有权酌情处理。但平台对用户的处理不免除其应尽的法律责任。 用户在平台的任何行为，应同时遵守与平台及其关联公司所签订的各项协议。 平台有权随时变更本规则并在网站上予以公告。 若用户不同意相关变更，应立即停止使用平台的相关服务或产品。平台有权对用户行为及应适用的规则进行单方认定，并据此处理。",
    relatedItems: "关联单品",
    chooSingPro: "选择单品",
    ...
    parameteNameAndParameterValue:
      "参数名和参数值显示在商品详情开头，参数名不超过10字，参数值不超过20字",
    // 虚拟商品
    otherSettings: "其他设置",
    ...
    afterSalesServiceTips:
      "商品详情页将展示“不支持申请退款”的说明，买家如需退款只能主动联系商家处理。",
    ...
    postProductTips5:
      "建议尺寸800*800像素，可拖动排序，最多上传9张，首图为主图",
    ...
    postProductTips12:
      "仅支持为第一组规格设置规格值图片，建议尺寸：800 x 800像素，规格值长度不超过20个字符",
    ...
    notAvailableSeparatePurchase:
      "活动商品不可以单买，仅用于套装和赠品的非主商品",
  ...
  shopWallet: {
    ...
    platfromIncomeBalanceTips:
      "用户确认收货15天后，增加平台收入金额（平台佣金 - 平台补贴金额)",
    ...
    availableStoreBalancesTip:
      "用户确认收货15天后，增加可用店铺余额，可用于店铺提现。",
  ...
  publics: {
    ...
    unPassed: "已审核未通过",
    sendCouponTips:
      "提示：批量发放优惠券时，库存不足或者达到用户领券上限则用户无法收到该优惠券。",
    sendVoucherTips:
      "提示：批量发放礼品券时，库存不足或者达到用户领券上限则用户无法收到该礼品券。",
    alertMessage1:
      "商品类目最多可添加3个层级，一级及二级类目只做为结构类目存在，未添加三级类目的类目不会在商城前台展示。对商品类目的修改或删除将会影响到商品展示与销售利润，请谨慎操作，尽量使用“修改”而避免“删除”！",
    selectAll: "全选",
    hadLowerShelf: "已下架",
    maxIndexImgNumOfPlatform: "每个用户端的最大轮播图数量为10",
    pointsRedemption: "氢春豆兑换",
    transferMoney: "转账汇款",
    creditPayment: "授信支付",
    user: "用户",
    business: "商家",
  ...
  coupon: {
    ...
    getWayTip:
      "该优惠券不能在用户端被直接领取，系统需通过【会员-会员列表】处勾选指定会员发放此优惠券",
    cancelLaunch: "取消投放",
  ...
  seckill: {
    ...
    stationOfflineTip:
      "确定对门店[STATIONNAME]进行下线操作？如是，请填写下线理由",
  ...
  groups: {
    ...
    activityWarmUp: "活动预热",
    cannotrOpen:
      "开启后，商品详情页展示未开始的拼团活动，但活动开始前用户无法拼团购买",
    submit: "提交",
    ...
    endTimeCannotBeEmpty: "结束时间不能为空",
    invalidate:
      "“使失效”即立即结束且不可再编辑，未成团订单将自动关闭并退款，已成团订单仍需及时处理。失效后的商品活动可删除。",
    tip1: "成团人数不能小于2人",
    tip2: "成团有效时间不能小于15分钟",
    ...
    failureTip:
      "“失效活动商品”即立即结束且不可再编辑，未成团订单将自动关闭并退款，已成团订单仍需及时处理。失效后的商品活动可删除。",
    isSuer: "确定对【",
    isDele: "】活动商品进行删除吗?",
    activityId: "活动id",
    proId: "商品id",
    ...
    buttonTips:
      "下架商家活动后，该活动的所有未拼团成功拼团团队将会拼团失败全部退款，商户需要重新申请成功后才能新建此商品的拼团活动，此操作可能会造成商家的经济损失，请谨慎操作！",
    platformAudit: "平台审核",
    removeActivityNameTips:
      "确定对活动[ACTIVITYNAME]进行下架操作？如是，请填写下架理由",
  ...
  components: {
    ...
    commodityPrice: "商品价格",
    whetherToContinue:
      "此操作将部分在限时特惠中的部分商品提交到秒杀活动中, 是否继续?",
  ...
  marketing: {
    ...
    discountTip2:
      "勾选的其他权益会显示在用户等级权益列表中，仅用于图标展示没有对应功能",
    fixedTime: "固定时间",
  ...
  distribution: {
    ...
    levelsOfUseIn: "团长直接推广商品给用户产生的奖励",
    levelsOfUseIn1: "上级团长通过下级团长推广商品给用户产生的奖励",
    grabCustomersType: "获取客户方式",
    basicDistributionSet: "分销基本设置",
    distributionSwitch: "分销开关",
    reciprocalBuying: "互购佣金",
    reciprocalBuyingTip: "团长之间通过分享的商品链接互相购买商品会产生佣金",
    selfPurchaseCommission: "自购佣金",
    selfPurchaseCommissionTip:
      "团长通过自己分享的商品链接购买自己的分享的商品会产生佣金",
    banTip1:
      "将用户永久封禁后，清空一切分销数据，平台不可再次更改状态，用户不可申请成为团长，确定继续操作？",
    banTip2:
      "将用户暂时封禁后，保留分销数据，用户不可申请成为团长，确定继续操作？",
    save: "保存",
    ...
    grabCustomers: "抢客方式",
    poTip2: "客户不在保护期内可被其他团长通过勾选的途径抢客",
    ...
    paTip2: "分享人优先",
    promptPaTip1:
      "用户购买了分销商品则与对应团长产生绑定关系（团长与团长之间也会有绑定关系），而后用户购买其他团长商品则绑定团长获得收益",
    promptPaTip2:
      "用户购买了分销商品则与对应团长产生不稳定绑定关系，而后用户购买其他团长商品则分享团长获得收益（与绑定无关）",
    bindingTime: "绑定时间",
    invalidTime: "失效时间",
    ...
    guardTime: "保护时间",
    guardTimeTip:
      "在保护时间内，团长B分享链接给团长A的用户购买，并不会有佣金，保护时间过后，团长A的用户通过团长B的链接购买商品，团长B有奖励，并且会绑定成为B的用户",
    ...
    invitedDistributorsColumn: "邀请团长数(人)",
  ...
  sysManagement: {
    ...
    wechatOpenPlatformApplicationConfig:
      "微信开放平台申请应用的配置（用于原生app）",
    ...
    webHookId: "webHookId",
    webHookIdTips:
      "webHookId 不用填写，如果值与paypal的app中Webhook配置不一致，请手动修改成与对应api接口域名一致的webHookId值",
    sensitiveConfiguration: "敏感词配置",
    sensitiveWord: "敏感词",
    sensitiveAlert:
      "每个敏感词之间用中文逗号进行分割，只能输入中文以及中文逗号，请谨慎填写，该配置约五分钟起效。",
    internationalConfig: "国际化配置",
    prodAudit: "商品审核",
    prodAuditTip:
      "开启之后商家新发布的或是要上架的商品将默认处于待审核状态，由平台审核后正常上架。",
  ...
  distribUserWallet: {
    mobileTelNumber: "团长手机号",
    status: "状态",
    distributorNickname: "团长昵称",
    waitTosettled: "待结算金额",
  ...
  dataAnalysis: {
    ...
    maybe: "或者",
    memberText4:
      "通过等级会员人数趋势分析，可以观察一段时间内各个等级会员人数变化趋势，如果采取了会员招募计划，可通过数据验证招募会员活动是否有效，如果会员人数上升明显，说明招募活动取得了很好的效果。",
    usernum: "注册会员数",
    ...
    memberLevelDateText1:
      "会员等级数据分析，可以观察一段时间内各个会员等级的客户数和客户成交数据情况，会员数量越多，并且支付金额越高，说明店铺会员贡献度越高。可以采取给会员发放",
    coupon: "优惠券",
    orConfig: "或者配置",
    ...
    transactionTips:
      "成交客户中数据对比均为根据选择时间的还比数据。比如，选择”最近一天“，则对比前一天的数据增长；选择“最近7天”，则对比前7天的数据增长",
    ...
    pageviews: "浏览量",
    pageviewsTips:
      "统计时间内，页面被访问的次数，一个人在统计时间内访问多次记为多次",
    numberOfVisitors: "访客数",
    visitorsTips:
      "统计时间内，页面被访问的去重人数，一个人在统计时间范围内访问多次只记为一个",
    clicks: "点击次数",
    clicksTips:
      "统计时间内，页面被用户点击的次数，一个人在统计时间范围内多次点击该页面会被计算为多次",
    clicksVisitors: "点击人数",
    clicksVisitorsTips:
      "统计时间内，点击页面的去重人数，一个人在统计时间范围内多次点击该页面会只会被计算为1次",
    clicksRatio: "点击率",
    ...
    shareTimes: "分享访问次数",
    shareTimesTips:
      "统计时间内，通过他人分享链接访问被分享页面的浏览量。“分享”指的是微信内点击右上方“...”分享到朋友圈、分享给好友；小程序海报、团长海报分享不计算在内.",
    sharePeopleTimes: "分享访问人数",
    sharePeopleTimesTips:
      "统计时间内，通过他人分享链接访问产生的访客数，单日去重、多天累加。一个人在同一天内访问多次只记为一人。小程序海报、团长海报分享不计算在内",
    guidingTransformation: "引导转化",
    gTOrderAmount: "引导下单金额",
    pleaseSelectIndicator: "请选择指标",
    gTTips:
      "统计时间内，该商详页商品本身、以及页面内个性化推荐的商品成功下单的商品金额，不含运费，且不剔除退款订单",
    gTNumber: "引导下单人数",
    gTOrderTips:
      "统计时间内，该商详页商品本身、以及页面内个性化推荐的商品成功下单的人数。一人多次下单记为一人，且退款后人数也不扣减。点击页面内的商品列表、商品、图片广告等带商品链接的文字或图片并下单的，都计算在内",
    bAOC: "引导访问-下单转化率",
    bAOCTips:
      "统计时间内，该页面的下单人数/页面访客数。点击商详页商品本身、以及页面内个性化推荐的商品并成功下单的人数，都计算在内",
    gtPA: "引导支付金额",
    gtPATips:
      "统计时间内，该页面直接引导成功支付的商品金额，不含运费，且不剔除退款金额。点击商详页商品本身、以及页面内个性化推荐的商品并成功支付的，都计算在内",
    gPayNumber: "引导支付人数",
    gPayNumberTips:
      "统计时间内，该页面直接引导成功支付的客户数，一人多次支付记为一人，且不剔除退款订单。点击商详页商品本身、以及页面内个性化推荐的商品并成功支付的，都计算在内",
    gVToP: "引导访问-支付转化率",
    gVToPTips:
      "统计时间内，该页面直接引导成功支付的人数/店铺访客数。若所选时间超过1天，访客数、支付人数跨天去重。点击商详页商品本身、以及页面内个性化推荐的商品并成功支付的，详页商品本身、以及页面内个性化推荐的商品并成功支付的，",
    upTo5: "最多选择5项",
    fiveItems: "5 个指标",
    android: "安卓",
    ...
    goodsDet: "商品整体概况",
    decText:
      "订单相关指标（如下单人数）以下单时间统计，支付相关指标（如支付人数）以支付成功时间统计（拼团订单成团算支付、货到付款订单发货算支付）。订单查询页面根据下单时间查询对应订单，若顾客当日下单，次日支付，则下单与支付数据会有一天时间差，请注意区分！ ",
    ...
    refundRate: "退款率",
    descText1:
      "1.订单相关指标（如下单人数）以下单时间统计，支付相关指标（如支付人数）以支付成功时间统计（拼团订单成团算支付、货到付款订单发货算支付）。订单查询页面根据下单时间查询对应订单。",
    descText1Content:
      "若顾客当日下单、次日支付，则下单与支付数据会有一天时间差，请注意区分。",
    descText2:
      "2. 选择自然周、自然月、近7天、近30天时，人数在所选时间段内去重。",
    hideTips: "已隐藏无数据的商品",
    visitorsContent:
      "统计时间内，商品详情页被访问的去重人数，一个人在统计时间范围内访问多次记为一人。注意，若顾客浏览商品列表并直接加购、下单，未进入商详页，则不会记入该商品的访客数，此时，会出现商品的访客数小于支付人数的情况",
    ...
    prodSurveyTips4:
      "统计时间内，所有商品详情页被访问的次数，一个人在统计时间内访问多次记为多次",
    prodSurveyTips5:
      "统计时间内，访问任何商品详情页的人数，一个人在统计时间范围内访问多次只记为一个",
    ...
    customPath: "顾客浏览路径图",
    pathText:
      "顾客进店后的前10步访问路径。助你分析店内哪些页面访客更多、停留更久、流失率更低。",
    pathText2:
      "同一个访客访问多次，会产生多次会话。距离上一次操作超过30分钟时，视为一次新的会话。",
    step1: "第 1 步",
    step2: "第 2 步",
    step3: "第 3 步",
    step4: "第 4 步",
    ...
    mapText:
      "若在统计时间内，一个客户从新客户成为老客户，在新客阶段的消费行为会统计为新客数据，老客阶段的消费行为会统计为老客数据。",
    totalPayment: "支付总额",
    payment: "支付金额分布明细",
    ...
    customerTips:
      "访客数：筛选时间内，店铺所有页面被访问的去重人数，一个人在筛选时间范围内访问多次只记为一个。累积付费会员数：截至到筛选时间的最后一天，平台的付费会员总数。累积会员数：截至到筛选时间的最后一天，店铺的会员累积人数。成交客户数：筛选时间内，在店铺中付款成功的去重客户数，一个人在筛选时间范围内付款多次只记为一个",
    ...
    statisticsTips:
      "累积会员数：截至到筛选时间的最后一天，平台的会员累积人数。新增会员数：筛选时间内，通过注册新成为会员的客户数量。升级会员数：筛选时间内，通过会员规则升级的会员数量，一人多次升级记为一人。储值会员数：筛选时间内，进行储值的会员数量，一人多次储值记为一人。",
    visitMembers: "访问会员数",
  ...
  shop: {
    ...
    rightsConflict:
      "其他权益选项处于选中但子选项没有选择任何项，可能由于其他权益中的部分权益信息与折扣权益发生了冲突",
    hotTitle: "热搜标题",
    setUpShop: "店铺设置",
    hotContent: "热搜内容",
    recDate: "录入时间",
    ...
    pendingSettlementTip:
      "用户购买商品之后，等待用户确认收货15天后，将会变成可用店铺余额",
    platfromPendingSettlementTip:
      "用户购买商品之后，等待用户确认收货15天后，将会变成平台收入金额",
    unusableBalanceYuan: "冻结金额(元)",
    unusableBalanceYuanTip:
      "商城进行提现申请的时候，将会把余额冻结，增加冻结金额",
    totalSettlementAmount: "总结算金额(元)",
    totalSettlementAmountTip:
      "用户确认收货15天后结算的所有金额，当用户发生退款的时候，总结算金额会减少",
  ...
  formData: {
    ...
    timeTip:
      "如选择近1天，则该报表会自动更新为 当前天 的数据，近2天，则该报表会自动更新为 当前天+昨天 的数据",
  ...
  settlementDetail: {
    ...
    tip5: "数量(不含退)：结算时订单中商品数量需排除掉退款完成的数量，结算时满减优惠金额、店铺优惠券优惠金额、平台优惠券优惠金额、使用氢春豆、订单改价差额、商品实付金额、供货金额都以不含退的数量来计算；",
    ...
    tip10:
      "使用氢春豆：用户在支付时使用使用氢春豆的部分，成本由平台承担，在结算时补偿给商家；",
    tip11:
      "商品实付金额：商品在进行了各类优惠活动、虚拟资产抵扣、订单改价后的实付金额；",
    tip12:
      "未改价订单商品实付金额=商品原价-满减优惠-满折优惠-店铺优惠券优惠金额-平台优惠券优惠金额-使用氢春豆",
    tip13: "有改价订单商品实付金额=改价后金额",
    tip14: "供货金额：代销供应商商品需要结算给供应商的金额；",
    tip15:
      "分账比例：商品所属类目产生销售时需支付给平台的佣金，结算比例以用户下单时为准；",
    tip16:
      "平台佣金：平台应收的佣金，每件商品平台佣金=（商品实付金额+平台优惠）*类目扣率，商品实付金额不包含商品运费；",
    tip17:
      "退单改价差额：订单产生退款，商家若修改退单金额导致商品实退金额小于实付金额，则在结算时将差额补偿给商家；",
    tip18: "运费：用户支付的运费，由平台代收，在结算时需返还给商家；",
    tip19:
      "店铺实收金额：每笔订单店铺实收金额=商品实付金额+退单改价差额+运费+平台优惠券优惠金额+使用氢春豆-平台佣金-分销佣金；",
    tip20: "店铺实收总额：店铺实收总额=每笔订单店铺实收金额之和",
    tip21: "商品实付总额：每笔订单商品实付金额之和；",
    tip22: "供货总额：每笔订单需结算给供货商的供货金额总和；",
    tip23: "平台佣金总额：每笔订单平台佣金之和；",
    tip24:
      "分销佣金比例 ：商家设置的团长代销商品可获得的佣金比例，结算比例以用户下单时为准；",
    tip25:
      "分销佣金：商家支付给团长的佣金，每款商品平台佣金=商品实付金额 * 佣金比例；",
    tip26: "分销佣金总额：每笔订单分销佣金之和；",
    tip27: "结算说明",

    tip2_2:
      "如果一笔订单进行整单退款或每个订单项都已经退款完成，那么会立即结算给商家。其他情况皆为确认收货15天后进行结算；",
    tip2_3: "名词解释：",
    tip2_4: "- 购买数量：用户购买商品数量，不包含售后数量；",
    tip2_5: "- 商品总金额：商品原价*购买数量，不包含售后金额；",
    tip2_6:
      "- 用户支付金额：扣除平台优惠(平台优惠券优惠、会员折扣优惠、氢春豆抵扣金额)、店铺优惠(优惠券、满减折、秒杀优惠、团购优惠、优惠套餐、订单改价)，商品实际支付的金额；",
    tip2_7: "- 商家优惠金额：商品使用店铺优惠总和，包含商家改价金额；",
    tip2_8:
      "- 平台优惠金额：商品使用平台优惠总和，成本由平台承担，在结算时补偿给商家；",
    tip2_9:
      "商家未改价：平台优惠金额=平台优惠券优惠+会员折扣优惠+氢春豆抵扣金额",
    tip2_10:
      "商家改价：平台优惠金额=原平台优惠-(商品减少金额/商品原价*(平台优惠券优惠+会员折扣优惠+氢春豆抵扣金额))",
    tip2_11: "- 平台津贴减少金额：商家改价减少的平台优惠金额；",
    tip2_12:
      "商家改价：平台津贴减少金额=商品减少金额/商品原价*(平台优惠券优惠+会员折扣优惠+氢春豆抵扣金额)",
    tip2_13: "- 分销金额：商家支付给团长的佣金；",
    tip2_14: "按比例奖励：分销金额=商品扣除平台优惠支付金额*分销奖励比例",
    tip2_15:
      "按固定数值奖励：分销金额=固定数值奖励，商品扣除平台优惠支付金额如果小于奖励数值，分销金额为0",
    tip2_16: "- 使用氢春豆：用户在支付时使用的氢春豆；",
    tip2_17: "- 类目扣率：该商品签约分类的对应扣率；",
    tip2_18: "- 平台佣金：商品所属类目产生销售时需支付给平台的佣金；",
    tip2_19:
      "每件商品的平台佣金=（商品实付金额+平台优惠券优惠+会员折扣优惠+氢春豆抵扣金额）*类目扣率；",
    tip2_20:
      "- 氢春豆抵扣金额：用户使用氢春豆抵扣的金额，根据平台端的使用比例和抵扣比例计算；",
    tip2_21:
      "- 会员折扣金额：会员等级特权中折扣产生的优惠金额，成本由平台承担，在结算时补偿给商家；",
    tip2_22:
      "- 平台优惠券优惠金额：商品使用了平台优惠券减免的金额，成本由平台承担，在结算时补偿给商家；",
    tip2_23:
      "- 商家优惠券优惠金额：商品使用了店铺优惠券减免的金额，成本由商家承担；",
    tip2_24:
      "- 满减优惠金额：商品参加满减、满折活动减免的金额，成本由商家承担；",
    ...
    tip2_33:
      "直营店包邮：用户等级特权中包邮产生的优惠金额，成本由平台承担，在结算时补偿给商家",
  ...
  user: {
    ...
    pointsOfRegistrationCannotEmpty: "注册氢春豆获取不能为空",
    pointsOfShoppingCannotEmpty: "购物氢春豆获取不能为空",
    shoppingPointsDeductedCannotEmpty: "购物氢春豆抵扣不能为空",
    usePointsCannotEmpty: "使用氢春豆上限百分比不能为零或者空",
    getPointsCannotEmpty: "获取氢春豆上限百分比不能为零或者空",
    pointsExpirationSetting: "氢春豆过期设置",
    expirationSwitch: "氢春豆过期开关：",
    expiration: "氢春豆过期时间：",
    year: "年",
    expirationDes:
      "配置的为最长的过期时间，即从获取氢春豆开始，自最长的n-1年的年底会将氢春豆清空。",
    expirationDes1: "（设置为1时，氢春豆会在获取氢春豆当年的年底过期）",
    expirationConfiguration: "氢春豆过期配置",
    enterExpiration: "请输入过期时间",
    pointsDesSetting: "氢春豆说明设置",
    pointsDes: "氢春豆说明",
    pointsEarnSetting: "氢春豆获取设置",
    pointSettings: "氢春豆设置",
    ...
    growthValueObtainedFromOrderConfirmationOfReceipt:
      "订单确认收货获取的成长值",
    ...
    rechargeTimes: "充值次数",
    refundTimes: "退款次数",
    cumulativeScore: "累计氢春豆",
    currentBalance: "当前余额",
    cumulativeBalances: "累计余额",
    tagTip1: "请输入标签名称搜索",
    growthTip1:
      "正数代表增加，负数代表减少，只能输入整数，根据修改后的成长值重新计算会员等级",
    growthTip2: "成长值数量",
    growthTip3: "只能是正整数或者负整数",
    growthTip4: "成长值数量不能为空",
    updateUserScore: "修改用户氢春豆",
    scoresChange: "氢春豆数量(增减)",
    ...
    changeTime: "变动时间",
    changeReason: "变动原因",
    registerScore: "注册送氢春豆",
    lockScore: "(氢春豆锁定中)",
    shopping: "购物",
    shoppingDeducteScore: "购物抵扣氢春豆",
    scoreExpired: "氢春豆过期",
    rechargeBalance: "余额充值",
    sysChangeScore: "系统更改氢春豆",
    changeScoreNum: "变动氢春豆",
    changeType: "变动类型",
    recharge: "充值",
    payment: "支付",
    refund: "退款",
  ...
  shopProcess: {
    ...
    identityCardTips:
      "请上传身份证正反面照片，仅限jpg、gif、png，大小不超过2M，仅限上传2张",
    ...
    customizeRateErrorTips:
      "自定义类目扣率数值在0~99.9999之间，最多保留4位小数",
