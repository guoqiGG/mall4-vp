const zhCn = {
  ...
  product: {
    ...
    productSellingPointsTip: '商品卖点展示在商品详情标题下面，长度不超过100个字符',
    isTop: '是否置顶',
    seq: '排序号',
    remark: '备注',
  ...
  publics: {
    ...
    sendVoucherTips: '提示：批量发放礼品券时，库存不足或者达到用户领券上限则用户无法收到该礼品券。',
  ...
  distribution: {
    ...
    selfPurchaseCommissionTip: '团长通过自己分享的商品链接购买自己的分享的商品会产生佣金',
    banTip1: '将用户永久封禁后，清空一切分销数据，平台不可再次更改状态，用户不可申请成为团长，确定继续操作？',
    banTip2: '将用户暂时封禁后，保留分销数据，用户不可申请成为团长，确定继续操作？',
    save: '保存',
    ...
    paTip1: '关系链优先',
    paTip2: '分享人优先',
    promptPaTip1: '用户购买了分销商品则与对应团长产生绑定关系（团长与团长之间也会有绑定关系），而后用户购买其他团长商品则绑定团长获得收益',
    promptPaTip2: '用户购买了分销商品则与对应团长产生不稳定绑定关系，而后用户购买其他团长商品则分享团长获得收益（与绑定无关）',
    bindingTime: '绑定时间',
    invalidTime: '失效时间',
    permanentBinding: '永久绑定',
    limitBind: '限时绑定',
    guardTime: '保护时间',
    guardTimeTip: '在保护时间内，团长B分享链接给团长A的用户购买，并不会有佣金，保护时间过后，团长A的用户通过团长B的链接购买商品，团长B有奖励，并且会绑定成为B的用户',
  ...
  dataAnalysis: {
    ...
    shareTimes: '分享访问次数',
    shareTimesTips: '统计时间内，通过他人分享链接访问被分享页面的浏览量。“分享”指的是微信内点击右上方“...”分享到朋友圈、分享给好友；小程序海报、团长海报分享不计算在内.',
    sharePeopleTimes: '分享访问人数',
    sharePeopleTimesTips: '统计时间内，通过他人分享链接访问产生的访客数，单日去重、多天累加。一个人在同一天内访问多次只记为一人。小程序海报、团长海报分享不计算在内',
  ...
  settlementDetail: {
    ...
    tip10: '使用氢春豆：用户在支付时使用使用氢春豆的部分，成本由平台承担，在结算时补偿给商家；',
    tip11: '商品实付金额：商品在进行了各类优惠活动、虚拟资产抵扣、订单改价后的实付金额；',
    tip12: '未改价订单商品实付金额=商品原价-满减优惠-满折优惠-店铺优惠券优惠金额-平台优惠券优惠金额-使用氢春豆',
    ...
    tip19: '店铺实收金额：每笔订单店铺实收金额=商品实付金额+退单改价差额+运费+平台优惠券优惠金额+使用氢春豆-平台佣金-分销佣金；',
    tip20: '店铺实收总额：店铺实收总额=每笔订单店铺实收金额之和',
    tip21: '商品实付总额：每笔订单商品实付金额之和；',
    tip22: '供货总额：每笔订单需结算给供货商的供货金额总和；',
    tip23: '平台佣金总额：每笔订单平台佣金之和；',
    tip24: '分销佣金比例 ：商家设置的团长代销商品可获得的佣金比例，结算比例以用户下单时为准；',
    tip25: '分销佣金：商家支付给团长的佣金，每款商品平台佣金=商品实付金额 * 佣金比例；',
    ...
    tip2_6: '- 用户支付金额：扣除平台优惠(平台优惠券优惠、会员折扣优惠、氢春豆抵扣金额)、店铺优惠(优惠券、满减折、秒杀优惠、团购优惠、优惠套餐、订单改价)，商品实际支付的金额；',
    tip2_7: '- 商家优惠金额：商品使用店铺优惠总和，包含商家改价金额；',
    tip2_8: '- 平台优惠金额：商品使用平台优惠总和，成本由平台承担，在结算时补偿给商家；',
    tip2_9: '商家未改价：平台优惠金额=平台优惠券优惠+会员折扣优惠+氢春豆抵扣金额',
    tip2_10: '商家改价：平台优惠金额=原平台优惠-(商品减少金额/商品原价*(平台优惠券优惠+会员折扣优惠+氢春豆抵扣金额))',
    tip2_11: '- 平台津贴减少金额：商家改价减少的平台优惠金额；',
    tip2_12: '商家改价：平台津贴减少金额=商品减少金额/商品原价*(平台优惠券优惠+会员折扣优惠+氢春豆抵扣金额)',
    ...
    tip2_19: '每件商品的平台佣金=（商品实付金额+平台优惠券优惠+会员折扣优惠+氢春豆抵扣金额）*类目扣率；',
    tip2_20: '- 氢春豆抵扣金额：用户使用氢春豆抵扣的金额，根据平台端的使用比例和抵扣比例计算；',
  ...
  user: {
    ...
    expiration: '氢春豆过期时间：',
    year: '年',
    expirationDes: '配置的为最长的过期时间，即从获取氢春豆开始，自最长的n-1年的年底会将氢春豆清空。',
